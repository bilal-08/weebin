import { Controller, Get, Param, Post, Query,Body, Headers } from '@nestjs/common';
...
export class AppController {
  ...
  constructor(private readonly appService: AppService,private readonly codeService:CodeService) {}
